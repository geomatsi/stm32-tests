...
VPATH += $(PRJ_DIR)/boards/$(PLAT)/apps/rtc-alarm
...
rtc-alarm: $(OBJ_DIR)/rtc-alarm.bin
	cp $(OBJ_DIR)/rtc-alarm.bin $(OBJ_DIR)/test.bin
	$(OBJSIZE) $(OBJ_DIR)/rtc-alarm.elf
...
$(OBJ_DIR)/rtc-alarm.elf: $(APP_OBJS) $(LIBS) $(LDSCRIPT)
